...
func (r *PostgresHabitRepository) Create(ctx context.Context, habit *entity.Habit) error {
	...
	_, err := r.db.ExecContext(ctx, query, habit.ID, habit.UserID, habit.Name, habit.Description, habit.Motivation, habit.Color, habit.Category, habit.Frequency, habit.TargetCount, habit.TargetDays, habit.CurrentStreak, habit.BestStreak, habit.TotalCompletions, habit.IsActive, habit.CreatedAt, habit.UpdatedAt)
